...
export function RegisterRoutes(app: express.Express) {
    ...
    app.post('/users',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.criar.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.put('/users/:id',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.atualizar.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.delete('/users/:id',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.deletar.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/users/:id',
        ...
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.BuscarPorID.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
